...
var ground_scenes = [PRELOADS.ground_plant_scene, PRELOADS.ground_lizard_scene,
PRELOADS.ground_crystal_scene, PRELOADS.ground_eyeball_scene, PRELOADS.ground_mushroom_scene]
